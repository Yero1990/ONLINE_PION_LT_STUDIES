...
void checkCalib(string spec, int run)
{
  ...
  if (spec.compare("all")==0 ){
    ...
    mkdir(Form("./checkCalib_%d", run), S_IRWXU);
    
    mkdir(Form("./checkCalib_%d/HMS", run), S_IRWXU);
    mkdir(Form("./checkCalib_%d/SHMS", run), S_IRWXU);
  ...
  hdcRes_xmax = 0.13,	     		     pdcRes_xmax = 0.13;	     
  ...
  TString filename = Form("./ROOTfiles/Pion_coin_replay_checkCalib_cyero_%d_100000.root", run);
  ...
  if (spec.compare("all")==0 ){
    outROOT = new TFile(Form("./checkCalib_%d/checkCalib_histos%d.root", run, run), "recreate");
  }
  ...
  for (Int_t npl = 0; npl < dc_PLANES; npl++ )
    {
      ...
      double upperlim =  H_hdcDist[npl]->GetBinContent(binmax) + 200.;
  ...
  hdcTimeCanv->SaveAs(Form("./checkCalib_%d/HMS/hDC_Times.pdf",  run));
  hdcDistCanv->SaveAs(Form("./checkCalib_%d/HMS/hDC_Dist.pdf",  run));
  hdcResCanv->SaveAs(Form("./checkCalib_%d/HMS/hDC_Res.pdf",  run));
  
  hdcResCanv2D->SaveAs(Form("./checkCalib_%d/HMS/hDC_Res2D.pdf",  run));
  hdcTimeCanv2D->SaveAs(Form("./checkCalib_%d/HMS/hDC_Time2D.pdf",  run));
  hdcDistCanv2D->SaveAs(Form("./checkCalib_%d/HMS/hDC_Dist2D.pdf",  run));
  
  
  hdcResCanvProf->SaveAs(Form("./checkCalib_%d/HMS/hDC_ResProfile.pdf",  run));
  hdcResGraphCanv->SaveAs(Form("./checkCalib_%d/HMS/hDC_ResPlot.pdf",  run));
  ...
  hcalCanv->SaveAs(Form("./checkCalib_%d/HMS/hCal_CalibPlots.pdf",  run));
  ...
  hhodCanv->SaveAs(Form("./checkCalib_%d/HMS/hHodBetaPlots.pdf",  run));
  hhodCanv2D->SaveAs(Form("./checkCalib_%d/HMS/hHodBeta2DPlots.pdf",  run));
  hhodProfCanv->SaveAs(Form("./checkCalib_%d/HMS/hHodBetaProfilePlots.pdf",  run));
  ...
  hcerCanv->SaveAs(Form("./checkCalib_%d/HMS/hCer.pdf", run));
  ...
  for (Int_t npl = 0; npl < dc_PLANES; npl++ )
    {
      ...
      double upperlim =  H_pdcDist[npl]->GetBinContent(binmax) + 200.;
  ...
  pdcTimeCanv->SaveAs(Form("./checkCalib_%d/SHMS/pDC_Times.pdf",  run));
  pdcDistCanv->SaveAs(Form("./checkCalib_%d/SHMS/pDC_Dist.pdf",  run));
  pdcResCanv->SaveAs(Form("./checkCalib_%d/SHMS/pDC_Res.pdf",  run));
  
  pdcResCanv2D->SaveAs(Form("./checkCalib_%d/SHMS/pDC_Res2D.pdf",  run));
  pdcTimeCanv2D->SaveAs(Form("./checkCalib_%d/SHMS/pDC_Time2D.pdf",  run));
  pdcDistCanv2D->SaveAs(Form("./checkCalib_%d/SHMS/pDC_Dist2D.pdf",  run));
  
  
  pdcResCanvProf->SaveAs(Form("./checkCalib_%d/SHMS/pDC_ResProfile.pdf",  run));
  pdcResGraphCanv->SaveAs(Form("./checkCalib_%d/SHMS/pDC_ResPlot.pdf",  run));
  ...
  pcalCanv->SaveAs(Form("./checkCalib_%d/SHMS/pCal_CalibPlots.pdf",  run));
  ...
  phodCanv->SaveAs(Form("./checkCalib_%d/SHMS/pHodBetaPlots.pdf",  run));
  phodCanv2D->SaveAs(Form("./checkCalib_%d/SHMS/pHodBeta2DPlots.pdf",  run));
  phodProfCanv->SaveAs(Form("./checkCalib_%d/SHMS/pHodBetaProfilePlots.pdf",  run));
  ...
  phgcerCanv->SaveAs(Form("./checkCalib_%d/SHMS/pHGCER_PMTs.pdf",  run));
  pngcerCanv->SaveAs(Form("./checkCalib_%d/SHMS/pNGCER_PMTs.pdf",  run));

  phgcerSumCanv->SaveAs(Form("./checkCalib_%d/SHMS/pHGCER_SUM.pdf",  run));
  pngcerSumCanv->SaveAs(Form("./checkCalib_%d/SHMS/pNGCER_SUM.pdf",  run));
